...
<p>
  ...
  introduced by performing a simulation of a hard sphere fluid. The
...
<p>
  ...
  the video, the hard spheres are shown in their initial configuration
  generated by the <b>dynamod</b> tool. The particles are placed on a
  regular FCC lattice and assigned random velocities. The particles
  are then coloured by their ID number and the simulation is "run"
  using the <b>dynarun</b> tool.
</p>
<p>
  ...
  left and instantaneously reappear on the right). As the simulation
  proceeds, the initial lattice structure rapidly disappears. However,
  it is obvious from the clear colour banding that the particles have
  not actually moved very far from their initial positions. The system
  still has a "memory" of its initial configuration and we will need
  to equilibrate the system before we collect data.
</p>
<p>
