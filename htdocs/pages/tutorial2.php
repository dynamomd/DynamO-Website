...
<p>
  ...
  the start of the video, the hard spheres are shown in their initial
  configuration generated by the <b>dynamod</b> tool. The particles
  are placed on a regular FCC lattice and assigned random
  velocities. The simulation is then "run" using the <b>dynarun</b>
  tool.
</p>
<p>
  ...
  not actually moved very far. The system still has a "memory" of its
  initial configuration and we will need to equilibrate the system
