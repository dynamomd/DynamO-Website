...
<?php codeblockstart();?>
<System Type="Andersen" Name="Thermostat" MFT="1.00000000000000e+00" Temperature="1.00000000000000e+00" SetPoint="5.00000000000000e-02" SetFrequency="100">
  <IDRange Type="All"/>
</System>
<?php codeblockend("brush: xml;"); ?>
<p>
...
<ul>
  ...
  <li>
    <b>Name</b> <i>(attribute)</i>: The name of the System event
    source. This name is used to identify the System in the output
    generated by the dynarun command. Each System must have a name
    which is unique. 
  </li>
  <li>
    <b>MFT</b> <i>(attribute)</i>: The current mean free time over
    which the thermostat is applied.
  </li>
  <li>
  ...
  <li>
    <b>SetPoint</b> <i>(attribute)</i>: The target percentage of
    events which are applications of the thermostat.
  </li>
  <li>
