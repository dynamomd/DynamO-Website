...
<h2>Type="LEBC"</h2>
<p>
  <b>Description:</b> The "LEBC" boundary condition applies
  ...
  periodic images in motion. They are also known as sliding-brick
  boundary conditions.
</p>
<img src="/images/LEBC.png" alt="An illustration of the Lees-Edward sliding-brick boundary condition" width="700" height="251" style="display:block;margin:0 auto 0 auto;">
<p>
  <b>Example Usage:</b>
</p>
<?php codeblockstart();?><BC Type="LEBC" DXD="0" Rate="1"/><?php codeblockend("brush: xml;"); ?>
<p>
  <b>Full Tag, Subtag, and Attribute List</b>:
  <ul>
    <li>
      <b>Type</b> <i>(attribute)</i>: Must have the
      value <i>"LEBC"</i> to select this BC type.
    </li>
    <li>
      <b>DXD</b> <i>(attribute)</i>: This attribute stores the current
      displacement of the nearest periodic images in units of length.
    </li>
    <li>
      <b>Rate</b> <i>(attribute)</i>: This specifies how fast the
      boundary is shearing in units of primary image length per unit
      time.
    </li>
  </ul>
</p>
...
<p>
  ...
  from the system. As these planes are infinite, you must take care
  that they are axis-aligned if the system is periodic. They are not
  compatible with shearing simulations (see <a href="#">Lees-Edwards boundary conditions</a>).
</p>
<p>
  <b>Example Usage:</b>
</p>
...
<p>
  ...
  <ul>
    ...
    <li>
      ...
      reassigned from a Gaussian with the specified temperature. If it
      is not present, the particles will collide according to the
      elasticity.
    </li>
    <li>
